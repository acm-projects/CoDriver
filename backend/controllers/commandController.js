...
class CommandController {
    ...
    async musicCommand({ music }) {
        try {
            ...
            if ('play' in music) {
                const response = await axios.post('http://172.20.10.4:8000/api/music/play');
                return response.data;
            } else if ('pause' in music) {
                const response = await axios.post('http://172.20.10.4:8000/api/music/pause');
                return response.data;
            } else if ('next' in music) {
                const response = await axios.post('http://172.20.10.4:8000/api/music/next');
                return response.data;
            } else if ('previous' in music) {
                const response = await axios.post('http://172.20.10.4:8000/api/music/previous');
                return response.data;
            }
